...
cover:
  image: "/images/posts/exp-manual-hand-grinder.webp"
  alt: "수동 핸드밀 반년 넘게 써본 솔직한 후기"
---

## 사실 처음엔 실패부터 했습니다

솔직하게 먼저 고백하자면, 저의 첫 그라인더는 실패였어요. 커피용품 관련 소비자 정보는 [한국소비자원](https://www.kca.go.kr)에서도 확인할 수 있습니다. 홈카페를 막 시작할 때 별생각 없이 예전에 산 저가형 전동 그라인더를 하나 들였는데요. 문제는 분쇄가 너무 들쭉날쭉했다는 거예요. 굵은 가루랑 미분이 뒤섞여 나오니 아무리 정성껏 내려도 커피가 텁텁하고 지저분하게 나왔습니다. 그때는 제 실력 탓인 줄 알았어요.
...
<small>사진: <a href="https://unsplash.com/@yohanmarion?utm_source=inforcore-hugo&utm_medium=referral" target="_blank" rel="noopener">Yohan Marion</a> on <a href="https://unsplash.com/?utm_source=inforcore-hugo&utm_medium=referral" target="_blank" rel="noopener">Unsplash</a></small>
